...
class UserChangeForm(forms.ModelForm):
    ...
    class Meta:
        model = MyUser
        fields = ["email", "password", "buto_numeris", "is_active", "is_admin"]
...
class UserAdmin(BaseUserAdmin):
    ...
    fieldsets = [
        ...
        ("Personal info", {"fields": ["buto_numeris"]}),
    ...
    add_fieldsets = [
        (
            ...
            {
                "classes": ["wide"],
                "fields": ["email", "buto_numeris", "password1", "password2"],
            },
        ),
    ]
    search_fields = ["email"]
